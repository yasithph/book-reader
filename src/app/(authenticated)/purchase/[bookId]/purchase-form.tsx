...
const BANK_ACCOUNTS = [
  {
    ...
    accountName: "P.D.K.B.Amarasooriya",
    accountNumber: "8004809377",
    branch: "Galle Main Branch",
  },
  {
    bankName: "BOC",
    accountName: "P.D.K.B.Amarasooriya",
    accountNumber: "5330717",
          ...
          <>
            ...
            <section className="kindle-purchase-bank">
              ...
              {BANK_ACCOUNTS.map((account, index) => (
                <div key={index} className="kindle-purchase-bank-rows" style={index > 0 ? { marginTop: '1rem', paddingTop: '1rem', borderTop: '1px solid rgba(255,255,255,0.08)' } : undefined}>
                  <div className="kindle-purchase-bank-row">
                    <span className="kindle-purchase-bank-label">Bank</span>
                    <span className="kindle-purchase-bank-value">{account.bankName}</span>
                  </div>

                  <div className="kindle-purchase-bank-row">
                    <span className="kindle-purchase-bank-label">Account Name</span>
                    <span className="kindle-purchase-bank-value">{account.accountName}</span>
                  </div>
                  ...
                  <div className="kindle-purchase-bank-row kindle-purchase-bank-row-copy">
                    ...
                    <div className="kindle-purchase-bank-copyable">
                      <span className="kindle-purchase-bank-value kindle-purchase-bank-mono">{account.accountNumber}</span>
                      <button
                  ...
                  <div className="kindle-purchase-bank-row">
                    ...
                    <span className="kindle-purchase-bank-value">{account.branch}</span>
                  </div>
                </div>
              ))}

              <div className="kindle-purchase-bank-rows" style={{ marginTop: '1rem', paddingTop: '1rem', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
